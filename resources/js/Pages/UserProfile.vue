                        ...
                        <div class="flex justify-center space-x-4 rtl:space-x-reverse">
                            <div v-if="!isOwnProfile" class="flex space-x-3">
                                <button
                                    v-if="!isFollowing"
                                    @click="followUser"
                                    class="nav-btn inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-[--brand-2] rounded-lg hover:bg-[--brand-2]/90 transition-all duration-200"
                                >
                            ...
                            <button
                                v-else
                                @click="editProfile"
                                class="nav-btn inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-[--brand-1] rounded-lg hover:bg-[--brand-1]/90 transition-all duration-200"
                            >
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
