    ...
    >
        <div class="flex items-start gap-4">
            ...
            <div class="flex-shrink-0 relative">
                ...
                <div v-if="hasUserAvatar" class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                    {{ getUserInitials() }}
                </div>
